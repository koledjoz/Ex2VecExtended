...
CURVES_PKL = Path("./curves_all_models_user451.pkl")
...
def plot_dual_interaction_impact(
    ...
    gs = gridspec.GridSpec(
        ...
        figure=fig,
        width_ratios=[38, 1.5],
        height_ratios=[0.55, 2.6, 2.6, 1.5],
        wspace=0.05,
        hspace=0.42,
    )
    ...
    ax_hist.set_xlabel("Interaction relevance (log scale; shown range $10^{-4}$ to 1)")
    ...
    cbar.set_label("Interaction relevance (log color scale)")
