...
def eval_epoch_extended(epoch_id, dataloader, model, loss_fn, metrics={}, device='cpu', writer=None, verbose=True):
    model.eval()
...
def train_model_extended(epochs_done, epoch_count, model, optimizer, dataloader_train, dataloader_val, loss_fn, metrics={},
    ...
    while curr_epoch_id < epoch_count:
        train_epoch_extended(curr_epoch_id, dataloader_train, model, optimizer, loss_fn, device, writer, verbose)

        if dataloader_val is not None:
            epoch_loss = eval_epoch_extended(curr_epoch_id, dataloader_val, model, loss_fn, metrics, device, writer,
                                             verbose)
...
def prepare_training_extended(model, train_data, val_data, checkpoint, train_config, log_dir=None):
